  ...
  window.__ModuleLoader__.load({
    ...
    factory: function (require) {
      ...
      var CSS_TEXT = [
        ...
        '.cdx-am-search-input { width: 100%; height: 36px; padding: 0 34px 0 34px; background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.12); border-radius: 18px; color: var(--dsw-alias-label-primary, #f9fafb); font-size: 13px; outline: none; box-sizing: border-box; transition: border-color 0.15s, background 0.15s; }',
        '.cdx-am-search-input:focus { border-color: var(--dsw-alias-brand-primary, #3b82f6); background: rgba(255,255,255,0.09); }',
        '.cdx-am-search-input::placeholder { color: var(--dsw-alias-label-tertiary, #86909c); }',
        '.cdx-am-search-clear { position: absolute; right: 10px; top: 50%; transform: translateY(-50%); width: 20px; height: 20px; border-radius: 50%; background: rgba(255,255,255,0.12); border: none; color: var(--dsw-alias-label-tertiary, #86909c); cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.12s; }',
        '.cdx-am-search-clear:hover { background: rgba(255,255,255,0.22); color: #fff; }',
        '.cdx-am-filter-row { display: flex; align-items: center; gap: 10px; width: 100%; box-sizing: border-box; }',
        '.cdx-am-dropdown { height: 34px; flex: 1; min-width: 0; padding: 0 12px; background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.12); border-radius: 18px; color: var(--dsw-alias-label-primary, #f9fafb); font-size: 13px; outline: none; cursor: pointer; display: inline-flex; align-items: center; gap: 6px; user-select: none; position: relative; box-sizing: border-box; }',
        '.cdx-am-dropdown:hover { background: rgba(255,255,255,0.1); }',
        ...
        '.cdx-am-btn-more:hover { color: var(--dsw-alias-label-primary, #f9fafb); background: rgba(255,255,255,0.08); }',
        '.cdx-am-menu-popover { position: absolute; right: 0; top: calc(100% + 4px); z-index: 100; background: var(--dsw-alias-bg-layer-2, #262626); border: 1px solid rgba(255,255,255,0.15); border-radius: 8px; padding: 4px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); white-space: nowrap; width: max-content; display: none; }',
        '.cdx-am-menu-popover[data-open="true"] { display: block; animation: cdxFadeIn 0.12s ease-out; }',
        '.cdx-am-menu-item { width: 100%; height: 32px; padding: 0 12px; border-radius: 4px; background: transparent; border: none; color: #f87171; font-size: 13px; text-align: left; cursor: pointer; display: flex; align-items: center; gap: 8px; white-space: nowrap; transition: background 0.12s; }',
        '.cdx-am-menu-item:hover { background: rgba(239, 68, 68, 0.15); color: #fca5a5; }',

        '.cdx-am-group-title { display: inline-flex; align-items: center; gap: 8px; font-weight: 500; }',
        ...
        '.cdx-am-group-list { background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.09); border-radius: 12px; overflow: hidden; display: flex; flex-direction: column; }',
        '.cdx-am-item { display: flex; align-items: center; justify-content: space-between; padding: 12px 14px; border-bottom: 1px solid rgba(255,255,255,0.06); transition: background 0.12s; gap: 12px; }',
        '.cdx-am-item:last-child { border-bottom: none; }',
        '.cdx-am-item:hover { background: rgba(255,255,255,0.04); }',
        '.cdx-am-item-main { display: flex; flex-direction: column; gap: 4px; min-width: 0; flex: 1; }',
        '.cdx-am-item-title { color: var(--dsw-alias-label-primary, #f9fafb); font-size: 13.5px; font-weight: 500; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; line-height: 1.4; }',
        ...
        '.cdx-am-btn-icon:hover { color: #f87171; background: rgba(239, 68, 68, 0.12); }',
        '.cdx-am-btn-unarchive { height: 28px; padding: 0 12px; border-radius: 6px; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.12); color: var(--dsw-alias-label-primary, #f9fafb); font-size: 12px; font-weight: 500; cursor: pointer; display: inline-flex; align-items: center; justify-content: center; transition: all 0.15s; }',
        '.cdx-am-btn-unarchive:hover { background: rgba(255,255,255,0.15); border-color: rgba(255,255,255,0.25); }',
        ...
        '.cdx-am-toast-error { background: rgba(239, 68, 68, 0.15); color: #fca5a5; border: 1px solid rgba(239, 68, 68, 0.3); }',
        '.cdx-am-toast-success { background: rgba(34, 197, 94, 0.15); color: #86efac; border: 1px solid rgba(34, 197, 94, 0.3); }',
        ...
        '.cdx-am-toast-close:hover { opacity: 1; background: rgba(255,255,255,0.1); }',
