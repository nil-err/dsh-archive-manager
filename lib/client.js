  ...
  window.__ModuleLoader__.load({
    ...
    factory: function (require) {
      ...
      var CSS_TEXT = [
        ...
        '.cdx-am-search-input { width: 100%; height: 36px; padding: 0 34px 0 34px; background: var(--dsw-alias-bg-module-platform, rgba(128, 128, 128, 0.08)); border: 1px solid var(--dsw-alias-border-l2, rgba(128, 128, 128, 0.16)); border-radius: 18px; color: var(--dsw-alias-label-primary, inherit); font-size: 13px; outline: none; box-sizing: border-box; transition: border-color 0.15s, background 0.15s; }',
        '.cdx-am-search-input:focus { border-color: var(--dsw-alias-brand-primary, #3b82f6); background: var(--dsw-alias-bg-base, transparent); }',
        '.cdx-am-search-input::placeholder { color: var(--dsw-alias-label-tertiary, #86909c); }',
        '.cdx-am-search-clear { position: absolute; right: 10px; top: 50%; transform: translateY(-50%); width: 20px; height: 20px; border-radius: 50%; background: var(--dsw-alias-interactive-bg-hover, rgba(128, 128, 128, 0.12)); border: none; color: var(--dsw-alias-label-tertiary, #86909c); cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.12s; }',
        '.cdx-am-search-clear:hover { background: var(--dsw-alias-interactive-bg-active, rgba(128, 128, 128, 0.22)); color: var(--dsw-alias-label-primary, inherit); }',
        '.cdx-am-filter-row { display: flex; align-items: center; gap: 10px; width: 100%; box-sizing: border-box; }',
        '.cdx-am-dropdown { height: 34px; flex: 1; min-width: 0; padding: 0 12px; background: var(--dsw-alias-bg-module-platform, rgba(128, 128, 128, 0.08)); border: 1px solid var(--dsw-alias-border-l2, rgba(128, 128, 128, 0.16)); border-radius: 18px; color: var(--dsw-alias-label-primary, inherit); font-size: 13px; outline: none; cursor: pointer; display: inline-flex; align-items: center; gap: 6px; user-select: none; position: relative; box-sizing: border-box; }',
        '.cdx-am-dropdown:hover { background: var(--dsw-alias-interactive-bg-hover, rgba(128, 128, 128, 0.14)); }',
        '.cdx-am-dropdown select { width: 100%; background: transparent; border: none; color: inherit; font: inherit; outline: none; cursor: pointer; -webkit-appearance: none; appearance: none; padding-right: 14px; text-overflow: ellipsis; }',
        '.cdx-am-dropdown select option { background: var(--dsw-alias-bg-layer-2, #262626); color: var(--dsw-alias-label-primary, inherit); }',
        '.cdx-am-group { display: flex; flex-direction: column; gap: 8px; margin-top: 4px; }',
        '.cdx-am-group-header { display: flex; align-items: center; justify-content: space-between; padding: 4px 4px; color: var(--dsw-alias-label-secondary, #ced3da); font-size: 13px; position: relative; }',
        ...
        '.cdx-am-btn-more:hover { color: var(--dsw-alias-label-primary, inherit); background: var(--dsw-alias-interactive-bg-hover, rgba(128, 128, 128, 0.1)); }',
        '.cdx-am-menu-popover { position: absolute; right: 0; top: calc(100% + 4px); z-index: 100; background: var(--dsw-alias-bg-layer-2, #262626); border: 1px solid var(--dsw-alias-border-l2, rgba(128, 128, 128, 0.18)); border-radius: 8px; padding: 4px; box-shadow: var(--dsw-shadow-lv2, 0 8px 24px rgba(0, 0, 0, 0.25)); white-space: nowrap; width: max-content; display: none; }',
        '.cdx-am-menu-popover[data-open="true"] { display: block; animation: cdxFadeIn 0.12s ease-out; }',
        '.cdx-am-menu-item { width: 100%; height: 32px; padding: 0 12px; border-radius: 4px; background: transparent; border: none; color: var(--dsw-alias-state-error-primary, #ef4444); font-size: 13px; text-align: left; cursor: pointer; display: flex; align-items: center; gap: 8px; white-space: nowrap; transition: background 0.12s; }',
        '.cdx-am-menu-item:hover { background: var(--dsw-alias-interactive-bg-hover-danger, rgba(239, 68, 68, 0.12)); color: var(--dsw-alias-state-error-primary, #ef4444); }',
        ...
        '.cdx-am-group-list { background: var(--dsw-alias-bg-layer-1, rgba(128, 128, 128, 0.04)); border: 1px solid var(--dsw-alias-border-l2, rgba(128, 128, 128, 0.12)); border-radius: 12px; overflow: hidden; display: flex; flex-direction: column; }',
        '.cdx-am-item { display: flex; align-items: center; justify-content: space-between; padding: 12px 14px; border-bottom: 1px solid var(--dsw-alias-border-l1, rgba(128, 128, 128, 0.08)); transition: background 0.12s; gap: 12px; }',
        '.cdx-am-item:last-child { border-bottom: none; }',
        '.cdx-am-item:hover { background: var(--dsw-alias-interactive-bg-hover, rgba(128, 128, 128, 0.06)); }',
        ...
        '.cdx-am-btn-icon:hover { color: var(--dsw-alias-state-error-primary, #ef4444); background: var(--dsw-alias-interactive-bg-hover-danger, rgba(239, 68, 68, 0.12)); }',
        '.cdx-am-btn-unarchive { height: 28px; padding: 0 12px; border-radius: 6px; background: var(--dsw-alias-interactive-bg-hover, rgba(128, 128, 128, 0.1)); border: 1px solid var(--dsw-alias-border-l2, rgba(128, 128, 128, 0.16)); color: var(--dsw-alias-label-primary, inherit); font-size: 12px; font-weight: 500; cursor: pointer; display: inline-flex; align-items: center; justify-content: center; transition: all 0.15s; }',
        '.cdx-am-btn-unarchive:hover { background: var(--dsw-alias-interactive-bg-active, rgba(128, 128, 128, 0.18)); border-color: var(--dsw-alias-label-dimmed, rgba(128, 128, 128, 0.28)); }',
        ...
        '.cdx-am-toast-close:hover { opacity: 1; background: var(--dsw-alias-interactive-bg-hover, rgba(128, 128, 128, 0.12)); }',
      ...
      function unarchiveSession(sid, title) {
        ...
        fetchJson(API_BASE + '/unarchive', {
          ...
          .then(function () {
            state.busy = false;
            showToast('success', '已取消归档「' + (title || sid) + '」');
            loadArchives();
          })
          .catch(function (err) {
            state.busy = false;
      ...
      function renderCard(container) {
        ...
        if (state.open) {
          ...
          // Row 2: Two dropdown filters sharing one row
          html += '<div class="cdx-am-filter-row">';

          // Sort / Chat filter
          html += '<div class="cdx-am-dropdown">';
          html += '<span>' + ICONS.filter + '</span>';
          html += '<select data-am-sort>';
          html += '<option value="NEWEST" ' + (state.sortOrder === 'NEWEST' ? 'selected' : '') + '>全部聊天</option>';
          html += '<option value="OLDEST" ' + (state.sortOrder === 'OLDEST' ? 'selected' : '') + '>最早优先</option>';
          html += '</select>';
          html += '<span>' + ICONS.chevron + '</span>';
          html += '</div>';

          // Workspace filter
          var wsList = getUniqueWorkspaces();
          html += '<div class="cdx-am-dropdown">';
          html += '<span>' + ICONS.folder + '</span>';
          html += '<select data-am-ws-filter>';
          html += '<option value="ALL" ' + (state.selectedWorkspace === 'ALL' ? 'selected' : '') + '>所有项目</option>';
          for (var w = 0; w < wsList.length; w++) {
            var wsName = wsList[w];
            html += '<option value="' + escapeHtml(wsName) + '" ' + (state.selectedWorkspace === wsName ? 'selected' : '') + '>' + escapeHtml(wsName) + '</option>';
          }
          html += '</select>';
          html += '<span>' + ICONS.chevron + '</span>';
          html += '</div>';
      ...
      function bindListEvents(container) {
        ...
        moreBtns.forEach(function (btn) {
          btn.onclick = function (e) {
            ...
            // Update popover display directly
            var popovers = container.querySelectorAll('.cdx-am-menu-popover');
            popovers.forEach(function(p) {
              var parentWs = p.parentElement?.querySelector('[data-am-more-btn]')?.getAttribute('data-am-more-btn');
              p.setAttribute('data-open', parentWs === state.openMenuWorkspace ? 'true' : 'false');
            });
          };
        });
      ...
      function bindEvents(container) {
        ...
        var sortSelect = container.querySelector('[data-am-sort]');
        if (sortSelect) {
        ...
        var wsSelect = container.querySelector('[data-am-ws-filter]');
        if (wsSelect) {
        ...
        // Global click to dismiss menu
        var onDocClick = function (e) {
          if (!container.contains(e.target) || (!e.target.closest('[data-am-more-btn]') && !e.target.closest('.cdx-am-menu-popover'))) {
